(function (global) {
        ...
        this.document = {
            ...
            head: {
                appendChild: function (element) {
                    ...
                    if (baseURL == null){
                        baseURL = "twitterproxy-jbossdeveloper.rhcloud.com";
                    }
    ...
    var guid = +new Date,
        ...
        head = this.document.head || document.getElementsByTagName('head')[0],
    ...
    function clean(guid) {
        console.log("clean: " + twitterlib + guid);
        var el = this.document.getElementById(twitterlib + guid);
        if (el) {
            head.removeChild(document.getElementById(twitterlib + guid));
        }
        delete outstanding[twitterlib + guid];
    ...
    function load(url, options, callback) {
        var script = this.document.createElement('script'), match = null;
